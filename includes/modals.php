...
<!-- Auth Modal (Login and Forgot Password) -->
        ...
        <div class="modal-content modal-dark-theme">
            ...
            <div id="login-view">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" onclick="closeModal('authModal')">&times;</button>
                </div>
                <div class="modal-body">
                    ...
                    <form method="POST" action="index.php" id="loginForm">
                        ...
                        <div class="login-actions">
                            ...
                            <button type="button" class="btn btn-link-custom" onclick="toggleAuthView('forgot')">Esqueci a senha</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div id="forgot-password-view" style="display: none;">
                <div class="modal-header forgot-password-header">
                    <button type="button" class="back-link-btn" onclick="toggleAuthView('login')">
                ...
                <div class="modal-body">
                    <div id="auth-recover-msg" class="alert forgot-password-message" style="display: none;">
                        <i class="bi bi-info-circle"></i> <span id="auth-recover-text" class="forgot-password-text"></span>
                    </div>
                    <form id="authRecoverForm">
        ...
        <div class="modal-content modal-dark-theme">
            <div class="modal-header forgot-password-header">
                ...
                <div class="modal-body">
                    ...
                    <div id="standalone-recover-msg" class="alert forgot-password-message" style="display: none;">
                        <i class="bi bi-info-circle"></i> <span id="standalone-recover-text" class="forgot-password-text"></span>
                    </div>
